 ...
 * <ul>
 *   <li>{@link org.eclipse.require.core.configuration.impl.ConfigurationImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigurationImpl extends EObjectImpl implements Configuration {
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this, ConfigurationPackage.CONFIGURATION__COMPONENTS);
		}
		return components;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConfigurationPackage.CONFIGURATION__COMPONENTS:
