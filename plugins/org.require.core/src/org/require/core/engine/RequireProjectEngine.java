...
public class RequireProjectEngine {
	...
	public static void checkAddDotProject(File dir, File dotFile, int segments, List<RequireProject> result,
			boolean parseDotProjectFile) {
	...
	private static void updatePaths(File dir, int segments, RequireProject info) {
		...
		IPath parentPath = new Path(dir.getAbsolutePath()).removeFirstSegments(segments).removeLastSegments(1)
				.setDevice(null);
